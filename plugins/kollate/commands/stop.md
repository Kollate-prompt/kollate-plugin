...
---
Run `python3 "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" pause stop || python "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" pause stop || py -3 "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" pause stop` and report its output in one line.
