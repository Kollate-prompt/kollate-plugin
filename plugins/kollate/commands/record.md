...
---
Run `python3 "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" record || python "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" record || py -3 "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" record` and report its output in one line.
