...
---
Run `python3 "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" resume || python "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" resume || py -3 "${CLAUDE_PLUGIN_ROOT}/hooks/kollate.py" resume` and report its output in one line.
